...
void TypeCheckerHelper::errorMainWithArgs()
{
	ErrorHandler::reportError(0,0,"Main function has parameters"); ++errorCount;
}

//Type mismatch 
void TypeCheckerHelper::errorTypeMismatch(int line, int col)
{
	ErrorHandler::reportError(line,col,"Type mismatch"); ++errorCount;
}
