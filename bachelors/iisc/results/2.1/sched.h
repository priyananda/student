 ...
 *  IISC(2.1) : Convergence scheduler 
 *  2003-09-21 added new members to task_struct and it's init
 */
...
/* signal handlers */
	...
	size_t sas_ss_size;
/* Shenoy's extra data*/
	// profiling priority - uses all kinds of things to calculate it
	unsigned long prof_priority ;
	// number of ticks elapsed in wait queue
	unsigned long prof_wait_ticks ;
	// How much cpu have you hogged lately
	unsigned long prof_cpu_hog ;
};
...
//PPS - My defs
#define PROF_PRIORITY_MEAN DEF_PRIORITY
#define PROF_PRIORITY_MAX  10
